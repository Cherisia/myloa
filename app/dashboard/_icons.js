...
export const IconCheck = ({ size = 9, strokeWidth = 3.5, className = '' }) => (
...
export const IconItemLevel = ({ className = '' }) => (
  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`opacity-60 ${className}`}>
    <path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/>
    <path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/>
    <path d="M4 22h16"/>
    <path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/>
...
export const IconPower = ({ className = '', size = 10 }) => (
  <Image src="/combat-power.svg" alt="전투력" width={size} height={size} unoptimized className={className} />
)
...
export const IconStar = ({ filled, size = 14 }) => (
...
export const IconUserCheck = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
