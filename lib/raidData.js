...
export const RAIDS = [
  ...
  // ── 세르카 (그림자 레이드) ────────────────────────────────────────────────
  {
    ...
    difficulties: [
      ...
      { key: 'normal',    label: '노말', minItemLevel: 1710, gates: 2, goldBound: [6500, 9500],  goldTrade: [6500,  9500],  goldMore: [4160,  6080] },
    ],
  },
  ...
  // ── 종막 : 카제로스 (에픽 레이드) ────────────────────────────────────────
  {
    ...
    minItemLevel: 1710,
    difficulties: [
      { key: 'hard',   label: '하드', minItemLevel: 1730, gates: 2, goldBound: [0,    0],     goldTrade: [16000, 32000], goldMore: [5120,  10240] },
      { key: 'normal', label: '노말', minItemLevel: 1710, gates: 2, goldBound: [5500, 10500], goldTrade: [5500,  10500], goldMore: [3520,  6720]  },
    ],
  },
  ...
  // ── 4막 : 아르모체 (에픽 레이드) ─────────────────────────────────────────
  {
    ...
    minItemLevel: 1700,
    difficulties: [
      { key: 'hard',   label: '하드', minItemLevel: 1720, gates: 2, goldBound: [0,    0],     goldTrade: [13500, 24500], goldMore: [4320, 7840] },
      { key: 'normal', label: '노말', minItemLevel: 1700, gates: 2, goldBound: [5000, 8500],  goldTrade: [5000,  8500],  goldMore: [3200, 5440] },
    ],
  },
